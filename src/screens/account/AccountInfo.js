...
class AccountInfo extends React.Component {
    ...
    render() {
        return (
            <>
                <View style={{ flex: 1 }}>
                    <Header navigation={this.props.navigation} back={true} rightIcon={'pen'} title={'Tài khoản của tôi'} />
                    <View style={{ alignItems: 'center' }}>
                        ...
                        <View style={{ flexDirection: 'row', height: scaleVertical(40), backgroundColor: 'white', marginTop: scaleVertical(1) }}>
                            ...
                            <View style={{ flex: 3, justifyContent: 'center', alignItems: 'flex-end' }}>
                                <Text style={{ fontSize: scaleModerate(12), paddingRight: scaleModerate(15) }}>{(this.props.accountInfo.mobile) ? this.props.accountInfo.mobile : 'Chưa có'}</Text>
                            </View>
                        </View>
                        ...
                        <View style={{ flexDirection: 'row', height: scaleVertical(40), backgroundColor: 'white', marginTop: scaleVertical(1) }}>
                            ...
                            <View style={{ flex: 3, justifyContent: 'center', alignItems: 'flex-end' }}>
                                <Text style={{ fontSize: scaleModerate(12), paddingRight: scaleModerate(15) }}>{(this.props.accountInfo.gender) ? this.props.accountInfo.gender : 'Chưa có'}</Text>
                            </View>
                        </View>
                        <View style={{ flexDirection: 'row', height: scaleVertical(40), backgroundColor: 'white', marginTop: scaleVertical(1) }}>
                            <View style={{ flex: 1.5, justifyContent: 'center', alignItems: 'flex-start' }}>
