...
class HomeScreen extends React.Component {
  ...
  _renderBesideService = () => (
    <View style={styles.service}>
      <TouchableOpacity style={{flex: 1, alignItems: 'center', paddingTop: scale(7)}}>
        <Icon style={{flex: 1}} name={'mobile-alt'} size={scale(30)} color={'#EDE574'}/>
        <Text style={{fontSize: scale(12), paddingBottom: scale(16), textAlign: 'center'}}>Nạp tiền điện
          thoại</Text>
      </TouchableOpacity>
      <TouchableOpacity style={{flex: 1, alignItems: 'center', paddingTop: scale(7)}}>
  ...
  render() {
    return (
      <View style={{alignItems: 'center'}}>
        {this._renderHeader()}
        {this._renderMainService()}
        {this._renderBesideService()}
      </View>
